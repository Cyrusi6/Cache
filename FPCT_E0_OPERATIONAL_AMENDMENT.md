...
3. A host-side release controller reads only the seed-completion marker and Kubernetes phase. It does not read predictions, correctness, accuracy, training loss, or mechanism metrics.
